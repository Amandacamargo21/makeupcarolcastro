            ...
            <div class="sobre_mim">
                ...
                <div class="description">
                    ...
                    <div class="desciption_text">
                        <span>Meu nome é Carol, e sou uma maquiadora que acredita que a beleza vem de dentro para fora.
                            Minha filosofia de trabalho é realçar a beleza natural de cada cliente, despertando o que há
                            de melhor em você. Amo trabalhar com cores, texturas e estilos diferentes, mas sempre com o
                            objetivo de destacar os traços mais bonitos de cada pessoa. Meu trabalho é meu hobby e minha
                            paixão, e gosto de sempre estar por dentro das novas técnicas e tendências.</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="gallery">
                    <div class="gallery__item gallery__item--1">
                        <a href="https://www.instagram.com/p/CkpOpV7st5u/" target="_blank">
                            <img class="gallery__img img1"
                                src="/assets/images/portifolio/314518551_805360827360179_7093560696473475514_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--2">
                        <a href="https://www.instagram.com/p/ClBvvaarkBx/" target="_blank">
                            <img class="gallery__img img2"
                                src="/assets/images/portifolio/315734649_541655027326191_3177675308471945791_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--3">
                        <a href="https://www.instagram.com/p/CmwJej3uDHY/" target="_blank">
                            <img class="gallery__img img3"
                                src="/assets/images/portifolio/322748664_853475045935114_2463602974882208221_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--4">
                        <a href="https://www.instagram.com/p/Cn5KMXKOeLt/" target="_blank">
                            <img class="gallery__img img4"
                                src="/assets/images/portifolio/327271534_2384780061684201_4296868122611506003_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--5">
                        <a href="https://www.instagram.com/p/Coj9fQ3OW7U/" target="_blank">
                            <img class="gallery__img img5"
                                src="/assets/images/portifolio/330209242_1170703103807259_6133131286613415901_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--6">
                        <a href="https://www.instagram.com/p/CrHTzHiMI9a/" target="_blank">
                            <img class="gallery__img img6"
                                src="/assets/images/portifolio/341348499_3455880704684749_139611860557769341_n.jpg"
                                alt="">
                        </a>
                    </div>
                    <div class="gallery__item gallery__item--7">
                        <a href="https://www.instagram.com/p/CkMe72jsAOv/" target="_blank">
                            <img class="gallery__img img7"
                                src="/assets/images/portifolio/312658661_136735705796506_8699692264206293063_n.jpg"
                                alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="container2">
            ...
            <div class="servicos">
                <div class="servico__item">
                    <img src="/assets/images/serviços/close-up-make-up-artist-applying-eyeshadow-woman-with-brush.jpg"
                        alt="" class="servico__item__img">
                    <span>Maquiagem</span>
                </div>
                <div class="servico__item">
        ...
        <div class="container_footer">
            ...
            <div class="row">
                ...
                <div class="social-icons">
                    ...
                    <a href="https://www.instagram.com/makeup_carolcastro/" target="_blank"><i
                            class="fa fa-instagram"></i></a>
                    <a href="https://www.facebook.com/profile.php?id=100000456974259" target="_blank"><i
